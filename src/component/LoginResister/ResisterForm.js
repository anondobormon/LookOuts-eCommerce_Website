...
export const ResisterForm = ({ googleSignUp, formData }) => {
  const {
    register,
    handleSubmit,
    formState: { errors },
  ...
  return (
    <div className="h-screen flex items-center justify-center pb-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8">
        ...
        <button onClick={googleSignUp} className="flex border p-1 rounded">
          <svg
            aria-hidden="true"
            focusable="false"
            data-prefix="fab"
            data-icon="google"
            className="svg-inline--fa fa-google fa-w-16 text-red-400 w-5 mx-2"
            role="img"

  ...
  return (
    <div className="max-w-2xl mx-auto py-4 px-4 sm:py-8 sm:px-6 lg:max-w-7xl lg:px-8 text-center">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 border">
        <div className="bg-yellow-500 flex justify-between overflow-hidden h-72 rounded-md">
          <img className="" src={img} alt="" />
          <div className="w-72 text-center py-14 h-full ">
        ...
        <div className=" grid grid-cols-1 md:grid-cols-2 gap-2 overflow-hidden h-72 rounded-md ">
          {Data.map((product) => (
